...
public class Point4f {
	...
	public Point4f PlusVector(Vector4f Additonal) { 
	 Point4f plus = new Point4f(Additonal.x + this.x,Additonal.y + this.y,Additonal.z + this.z,Additonal.a + this.a);
	 return plus;
	} 
	...
	public Point4f MinusVector(Vector4f Minus) { 
		Point4f sub = new Point4f(this.x - Minus.x,this.y - Minus.y,this.z - Minus.z,this.a - Minus.a);
		 return sub;
	}
	...
	public Vector4f MinusPoint(Point4f Minus) { 
		Vector4f sub = new Vector4f(this.x - Minus.x,this.y - Minus.y,this.z - Minus.z,this.a - Minus.a);
		 return sub;
	}
